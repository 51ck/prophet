...
Own concrete deck definitions the prophet uses for offer, ritual, and interpretation. Catalog and selection rules live in parent [deck-and-ritual.md](../deck-and-ritual.md).

## Ownership

- Full and stub deck bodies (identity, structure, orientation, meanings, imagery)
- Per-deck “when it fits” voice for offers

Parent owns shuffle/draw authenticity and selection flow. Spreads live in [spreads.md](../spreads.md).
