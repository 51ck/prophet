...
- [tech/](tech/AGENTS.md) — architecture: Pythia core vs channel adapters (TS / Mastra / Grammy); Telegram prototype→product task board. Does not weaken `spec/` authenticity.