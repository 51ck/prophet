...
- [x] **T3.14** Prompt/character: transparent profile use; never narrate saving; never imply access to other seekers
...
- [x] **T9.5** Prompt: present both paths without menu maze; after day card, invite deeper question only if natural
